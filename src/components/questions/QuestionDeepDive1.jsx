...
const QuestionDeepDive1 = ({ selectedValue, onSelect }) => {
  const options = [
    {
      id: 'Analyzer',
      icon: Search,
      title: 'Analyze',
      subtitle: 'Gather data, find patterns'
    },
    {
      id: 'Builder',
      icon: Users,
      title: 'Coordinate',
      subtitle: 'Rally team, facilitate'
    },
    {
      id: 'Innovator',
      icon: Lightbulb,
  ...
  const handleSelect = (value) => {
    ...
    setTimeout(() => {
      // The parent component should handle the advancement
    }, 500);
  };
            ...
            return (
              <div
                ...
                className={`
                  ...
                  ${isSelected
                    ? 'premium-card border-2 border-primary glow-effect'
...
export default QuestionDeepDive1;