  ...
  const options = [
    {
      ...
      icon: Brain,
      title: 'Solo',
      description: 'Extended blocks of uninterrupted, focused work time'
    },
    {
      value: 'team',
      icon: Users,
      title: 'Team',
      description: 'Regular collaboration mixed with individual contribution time'
    },
    {
      value: 'client',
      icon: Zap,
      title: 'Client',
      description: 'Frequent external interaction, meetings, and relationship management'
    }
  ];
